...
import anim_1 from "../../assets/website/anim-1.gif";
import anim_2 from "../../assets/website/anim-2.gif";
import anim_3 from "../../assets/website/anim-3.gif";
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-5">
                    <div data-aos="fade-up" className="flex items-center gap-3">
                      <img
                        className="text-2xl h-16 w-16 shadow-sm p-3 rounded-full bg-red-100 "
                        src={anim_2}
                        alt=""
                      />
                    ...
                    >
                      <img
                        className="text-2xl h-16 w-16 shadow-sm p-3 rounded-full bg-orange-100"
                        src={anim_1}
                        alt=""
                      />
                    ...
                    >
                      <img
                        className="text-2xl h-16 w-16 shadow-sm p-3 rounded-full bg-yellow-100"
                        src={anim_3}
                        alt=""
                      />
