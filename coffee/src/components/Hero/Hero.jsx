...
import arrow from "../../assets/website/anim.gif"

const Hero = () => {
  return (
    <>
      <div className="relative lg:h-screen min-h-[550px] sm:min-h-[600px] bg-gradient-to-r to-black  from-brandDark flex justify-center items-center text-white">
        ...
        <div className="absolute invisible lg:visible bottom-3 bg-transparent w-20">
                <img src={arrow} alt="" />
              </div>
      </div>
    </>
